...
public class BimSolicitudNoAtendidaActivity extends Activity {
    private Activity myActivity = this ;
    private static final String LOG_TAG = BimSolicitudNoAtendidaActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bim_solicitud_no_atendida);
        ...
        poll_id = GlobalConstant.poll_id[31] ;// 5 "Se encuentra Abierto el punto?"
    ...
    class loadPoll extends AsyncTask<Void, Integer , Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result){
                ...
                intent = new Intent(myActivity, BimDespuesEsperaActivity.class);
