...
public class BimTransaccionExitosaActivity extends Activity {

    private Activity myActivity = this ;
    private static final String LOG_TAG = BimTransaccionExitosaActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bim_transaccion_exitosa);
        ...
        poll_id = GlobalConstant.poll_id[33];
