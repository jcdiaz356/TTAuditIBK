...
public class BimAceptoOperacionActivity extends Activity {

    private Activity myActivity = this ;
    private static final String LOG_TAG = BimAceptoOperacionActivity.class.getSimpleName();
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result){
                ...
                if(is_sino ==1) {
                    ...
                    intent = new Intent(myActivity, BimSolicitudAtendidaActivity.class);
