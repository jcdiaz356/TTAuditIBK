...
public class BimSolucionTransaccionActivity extends Activity {

    private Activity myActivity = this ;
    private static final String LOG_TAG = BimSolucionTransaccionActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bim_solucion_transaccion);
        ...
        poll_id = GlobalConstant.poll_id[35] ;// 5 "Se encuentra Abierto el punto?"
    ...
    class loadPoll extends AsyncTask<Void, Integer , Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result){
                ...
                intent = new Intent(myActivity, BimComentarActivity.class);
