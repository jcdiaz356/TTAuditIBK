...
public class BimComentarActivity extends Activity {

    private Activity myActivity = this ;
    private static final String LOG_TAG = BimComentarActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        poll_id = GlobalConstant.poll_id[36];
