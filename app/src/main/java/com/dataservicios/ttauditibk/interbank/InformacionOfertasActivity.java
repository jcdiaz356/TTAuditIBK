...
public class InformacionOfertasActivity extends Activity {
    private Activity        myActivity = this ;
    private static final String LOG_TAG = InformacionOfertasActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_informacion_ofertas);
        ...
        poll_id = GlobalConstant.poll_id[39];
