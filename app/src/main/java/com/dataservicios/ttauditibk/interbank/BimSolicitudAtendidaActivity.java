...
public class BimSolicitudAtendidaActivity extends Activity {

    private Activity myActivity = this ;
    private static final String LOG_TAG = BimSolicitudAtendidaActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bim_solicitud_atendida);
        ...
        poll_id = GlobalConstant.poll_id[30];
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result){
                ...
                if(is_sino ==1) {
                    ...
                    intent = new Intent(myActivity, BimSolicitudNoAtendidaActivity.class);
                    intent.putExtras(argRuta);
                    startActivity(intent);
                    finish();
                }
