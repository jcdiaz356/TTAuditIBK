...
public class InformacionComisionesActivity extends Activity {
    private Activity        myActivity = this ;
    private static final String LOG_TAG = InformacionComisionesActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_informacion_comisiones);
        ...
        poll_id = GlobalConstant.poll_id[37];
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result){
                // loadLoginActivity();
                    ...
                    Intent intent;
                    intent = new Intent(myActivity, InformacionReferirEjecutivoActivity.class);
